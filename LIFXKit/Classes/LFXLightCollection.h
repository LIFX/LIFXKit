...
@interface LFXLightCollection : NSObject <LFXLightTarget>

@property (nonatomic, readonly, weak) LFXNetworkContext *networkContext;

@property (nonatomic, readonly) NSArray *lights;		// Contains LFXLight objects

// Convenience Query Methods
- (LFXLight *)lightForDeviceID:(NSString *)deviceID;	// Convenience Method

// note: There may be more than one light with a particular label
- (LFXLight *)firstLightForLabel:(NSString *)label;
- (NSArray *)lightsForLabel:(NSString *)label;			// Contains LFXLight objects
